# 4번 : [sample] urlparse한 컬럼 별 TF-IDF + 파생변수 + LGBM_cv5 (임계값 결정) + class_weight='balanced'
# 파생변수 : is_capital , is_factor , count_sc , is_http , count_path, len_query
# auc-roc = 0.9471888 , 최대 f1-score = 0.8502856, g-mean = 0.881312 , 최대 g-mean = 0.897956 (임계값 0.7)
import pandas as pd
import numpy as np
...
# test_pred.to_csv('../data/test/e_M4_pred.csv', index=False)
